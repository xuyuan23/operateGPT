...
from operategpt.embeddings.knowledge_type import get_knowledge_embedding, KnowledgeType
from operategpt.vector_store.connector import VectorStoreConnector
